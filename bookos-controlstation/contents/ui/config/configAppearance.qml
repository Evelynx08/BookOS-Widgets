...
KCM.SimpleKCM {
    ...
    property int maxNum: layout.currentIndex == 0 && !showBrightness.checked ? 4 :  (layout.currentIndex == 2 || layout.currentIndex == 3 || layout.currentIndex == 5 )? 6 : 2
    ...
    function toggleLayoutDefaults(index) {                    
        ...
        switch (index) {
            ...
            case 3:
                ...
                break;
            case 5:
                // BookOS preset — use system accent + clean slider styling
                useSystemColorsOnToggles.checked = true;
                useSystemColorsOnSliders.checked = true;
                usePlasmaSliders.checked = false;
                transparency.checked = true;
                transparencyLevel.value = 30;
                showBorders.checked = false;
                maxNum = 6;
                break;
