...
Item {
    ...
    // BookOS side-button: toggle dark/light theme
    property string colorSchemeCommand: root.preferChangeGlobalTheme ?
    ...
    function toggleColorScheme() {
        ...
        schemeExecutable.exec(`${colorSchemeCommand}"${colorSchemeName}"`);
    ...
    Component {
        ...
        Lib.Slider {
            ...
            bookosStyle: brightnessControl.bookosStyle
            showRightButton: brightnessControl.bookosStyle
            rightButtonSource: Qt.resolvedUrl("../icons/bookos/moon.svg")
            rightButtonCustomIcon: true
            rightButtonActive: root.isDarkTheme
            onRightButtonClicked: brightnessControl.toggleColorScheme()
