...
Item {
    ...
    // BookOS side-button: Do Not Disturb
    ...
    */
    ...
    Component {
        ...
        Lib.Slider {
            ...
            bookosStyle: volumeControl.bookosStyle
            showRightButton: volumeControl.bookosStyle
            rightButtonSource: Qt.resolvedUrl("../icons/bookos/dnd.svg")
            rightButtonActive: Funcs.checkInhibition()
            onRightButtonClicked: { Funcs.toggleDnd(); }
